export function NavigationBar() {
  return (<header
    className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 sm:py-0 dark:bg-neutral-800 dark:border-neutral-700">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="sm:hidden">
          <button type="button"
            ...
            <svg className="hs-collapse-open:block flex-shrink-0 hidden size-4" width="16" height="16" fill="currentColor"
                 viewBox="0 0 16 16">
              <path
        ...
        <div
          ...
          <div
            ...
            <button type="button"
              ...
              Dropdown
              <svg className="ms-2 size-2.5 text-gray-500 dark:text-neutral-500" width="16" height="16" viewBox="0 0 16 16"
            ...
            <div
              ...
              <div
                ...
                <button type="button"
                  ...
                  Sub Menu
                  <svg className="sm:-rotate-90 ms-2 size-2.5 text-gray-500 dark:text-neutral-500" width="16" height="16"
